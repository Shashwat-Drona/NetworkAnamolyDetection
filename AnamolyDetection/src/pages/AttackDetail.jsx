...
export default function AttackDetail() {
  ...
  if (error === "404") {
     return (
      <div className="bg-gray-900 min-h-screen p-6 flex flex-col items-center justify-center font-sans text-cyan-400">
  ...
  if (error) {
     return (
      <div className="bg-gray-900 min-h-screen p-6 font-sans text-cyan-400">
  ...
  return (
   <div className="bg-gray-900 min-h-screen p-6 font-sans text-cyan-400 flex flex-col space-y-6">
