...
export default function Traffic() {
  ...
  if (error) {
    return (
      <div className="p-6 bg-gray-900 min-h-screen text-cyan-400 font-sans lg:ml-64">
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-cyan-400 p-6 lg:ml-64 font-sans">
      <h1 className="text-3xl font-bold text-white mb-6">Traffic Analysis</h1>
